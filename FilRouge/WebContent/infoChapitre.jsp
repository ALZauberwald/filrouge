        ...
        <tr>
        	<td><i>Id Chapitre</i> <%= form.getIdChapitre() %> </td>
         	...
         	<td><i>Detail du Chapitre</i> <%= form.getDetailChapitre() %>  </td>
         	 ...
         	 <td><i>formation Ã  laquelle ce chapitre est rattache </i></br>  
         	 <% if(form.getFormation()==null){%>
         	Pas de formation associée<%}else{%>
...
<form action="UpdateChapitre2Servlet" method="POST">
	<table>
        ...
        <tr>
           	<th>Vous voulez changer la formation associee à ce chapitre ?</th><input type="HIDDEN" name="idChapitre" type="number" value="<%= form.getIdChapitre()%>">    	
        ...
        <tr>
           	...
           	<td><i>Voici la formation qui est pour l'instant liée a ce chapitre</i>
