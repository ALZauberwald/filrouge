...
public class DAOFormation {
	...
	public boolean addSession(String nomSession, Float prixSession , String dateDebut , String lieuSession ,TypeSession typesession, String adresse , String nomSalle  ) {
	...
	public boolean searchSession(long id) {
